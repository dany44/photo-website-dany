...
function HomePage() {
  ...
  // Settings pour le carousel albums
  ...
  // Settings pour le carousel articles (5 récents)
  const recent = Array.isArray(articles) ? articles.slice(0, 5) : [];
  const articleSliderSettings = {
    dots: false,
    infinite: false,
    speed: 400,
    slidesToShow: Math.min(recent.length, 3),
    slidesToScroll: 1,
    arrows: true,
    nextArrow: <NextArrow />,
    prevArrow: <PrevArrow />,
    responsive: [
      { breakpoint: 1024, settings: { slidesToShow: Math.min(recent.length, 2) } },
      ...
      <section className="bg-gray-800 text-white py-16 px-4 mt-12 shadow-inner">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg leading-relaxed max-w-3xl mx-auto">
            Bonjour, je suis Dany Khadhar. Découvrez ici mes photographies de voyage,
            capturant lieux, ambiances et instants de vie rencontrés en route.
          </p>
        </div>
      </section>
      ...
      <section className="mb-8 px-4 mt-12">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed">
            Explorez mes albums qui rassemblent les meilleurs moments de mes voyages.
          </p>
